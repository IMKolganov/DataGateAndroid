...
public class ClientAPI_OpenVPNClient extends ClientAPI_TunBuilderBase implements LogReceiverSwigInterface {
  ...
  public void start_cert_check(String client_cert, String clientkey, SWIGTYPE_p_std__optionalT_std__string_const_t ca) {
    ovpncliJNI.ClientAPI_OpenVPNClient_start_cert_check__SWIG_0(swigCPtr, this, client_cert, clientkey, SWIGTYPE_p_std__optionalT_std__string_const_t.getCPtr(ca));
  }

  public void start_cert_check(String client_cert, String clientkey) {
    ovpncliJNI.ClientAPI_OpenVPNClient_start_cert_check__SWIG_1(swigCPtr, this, client_cert, clientkey);
  }

  public void start_cert_check_epki(String alias, SWIGTYPE_p_std__optionalT_std__string_const_t ca) {
    ovpncliJNI.ClientAPI_OpenVPNClient_start_cert_check_epki(swigCPtr, this, alias, SWIGTYPE_p_std__optionalT_std__string_const_t.getCPtr(ca));
  }
