...
//
// DataGate override: on Android, do not call uninit_openssl() when the last Init
// refcount drops. JVM/coroutine worker threads may still run OpenSSL thread-local
// destructors after global teardown, causing SIGSEGV in rand_delete_thread_state.
